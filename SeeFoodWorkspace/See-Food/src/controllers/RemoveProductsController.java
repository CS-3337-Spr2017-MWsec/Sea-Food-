...
public class RemoveProductsController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<ProductBean> oldList = (ArrayList<ProductBean>) getServletContext().getAttribute("userProducts");
		...
		request.getServletContext().setAttribute("userProducts", newList);
